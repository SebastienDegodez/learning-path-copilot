...
- [Module 314 — Autoresearch](../03-ingenierie-de-contexte/314-autoresearch.md) : la méthodologie rigoureuse pour créer des skills qui fonctionnent — applicable aussi pour valider qu'un outil MCP est bien exploité par Copilot.
...
**Suivant** : [107 — Choix de modèles](./107-choix-de-modeles.md)
